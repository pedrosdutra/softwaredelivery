...
exports.userController = {
    ...
    createUser: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name_1, email, phone, password, existingUser, newUser, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, User_1.User.create({ name: name_1, email: email, phone: phone, password: password })];
                    case 2:
                        newUser = _b.sent();
